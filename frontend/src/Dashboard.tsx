 ...
 */
function StockEventReportDashboardItem({
    context
}: {
    ...
    const pluginName : string = "StockEventReport";
...
//  component
export function renderStockEventReportDashboardItem(context: InvenTreePluginContext) {
    checkPluginVersion(context);
    return <StockEventReportDashboardItem context={context} />;
}
