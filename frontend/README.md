# StockEventReport- Frontend Code

This directory contains the frontend code for the StockEventReport plugin.
...
This will compile the frontend into the `../stockeventreport/static` directory (ready for distribution).
